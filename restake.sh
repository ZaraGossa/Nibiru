...
for (( ;; )); do
	...
	nibid tx distribution withdraw-rewards nibivaloper12g8jq978y8zza5x99a6k7aqvttat77wmw954uu --from=Zaragossa --commission --chain-id=$NIBIRU_CHAIN_ID --fees=250unibi --yes
