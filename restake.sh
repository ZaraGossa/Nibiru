...
for (( ;; )); do
	...
	nibid tx distribution withdraw-rewards nibivaloper12g8jq978y8zza5x99a6k7aqvttat77wmw954uu --from=Zaragossa --commission --chain-id=$NIBIRU_CHAIN_ID --fees=10000unibi --yes
	...
	echo -e "Your total balance: \033[0;32m$AMOUNT_STRING\033[0m"
	 nibid tx staking delegate nibivaloper12g8jq978y8zza5x99a6k7aqvttat77wmw954uu $AMOUNT_STRING --from Zaragossa --chain-id $NIBIRU_CHAIN_ID --fees=10000unibi --yes
